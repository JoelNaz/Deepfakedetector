# video_analysis/kernel_utils.py - Your EXACT original code
import os
import cv2
import numpy as np
import torch
...
try:
    ...
    try:
        ...
        def image_compression(image, quality=90, image_type=".jpg"):
            """Fallback image compression using PIL"""
            import io
            from PIL import Image
            import numpy as np
...
class VideoReader:
    ...
    def _postprocess_frame(self, frame):
        ...
        if self.insets[1] > 0:
            H = frame.shape[0]  # Fixed: was frame.shape[1]
